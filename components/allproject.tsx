...
export default function AllProject({
  ...
  return (
    <>
      ...
      >
        <section className="bg-gray-100 max-w-[42rem] h-full  border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative  hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20 mx-auto ">
